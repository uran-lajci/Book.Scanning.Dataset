...
srw_mask = result['source'] == 'combined-synthetic'
plt.scatter(result.loc[srw_mask, 'PC1'], result.loc[srw_mask, 'PC2'], 
            c='yellow', label='Combined Synthetic', alpha=0.7, edgecolor='k')

srw_mask = result['source'] == 'synthetic-real-world'
plt.scatter(result.loc[srw_mask, 'PC1'], result.loc[srw_mask, 'PC2'], 
            c='black', label='Synthetic Real World', alpha=0.7, edgecolor='k')
