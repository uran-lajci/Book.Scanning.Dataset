...
def generate_instance(
    ...
    # Generate book scores with normal distribution
    ...
    # Create shared books pool for duplications
    ...
    for lib_id in range(num_libraries):
        # Generate library parameters with Poisson distribution around averages
        ...
        # Select books: mix of shared and unique
        ...
        # Update remaining books to prevent duplicates in unique selections
